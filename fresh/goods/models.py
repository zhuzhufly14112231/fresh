...
class CategoryModel(models.Model):
    ...
    # 分类的图片
    image = models.CharField(max_length=100, null=False, verbose_name='分类展示图片', default='/static/images/banner01.jpg')
...
class GoodsModel(models.Model):
    ...
    # 默认图片
    pic=models.CharField(null=False,max_length=200,verbose_name='商品默认图片',default='/static/images/goods/goods003.jpg')
    # 给分类添加一个外键
    category=models.ForeignKey(CategoryModel,on_delete=models.CASCADE,verbose_name='商品分类',default=2,null=False)
    # 人气
    popularity=models.IntegerField(default=0,verbose_name='人气指数')
